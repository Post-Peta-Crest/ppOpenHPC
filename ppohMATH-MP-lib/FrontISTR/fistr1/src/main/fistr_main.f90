...
use m_ppohMATHMP_FEM
        ...
        call ppohMATHMP_FEM_init("./coupling.nmlst") !カップラーの初期化
        call hecmw_init_ppohMATHMP(ppohMATHMP_FEM_get_my_comm())
...
!        call hecmw_get_mesh_jcup( name_ID , hecMESH, jf_get_my_comm() )
        call ppohMATHMP_FEM_def_grid() ! Jcup 格子情報の設定
        ...
        call ppohMATHMP_FEM_def_varg() ! Jcup 受信データの設定
        call ppohMATHMP_FEM_set_mapping_table() ! Jcup mapping tableの設定
