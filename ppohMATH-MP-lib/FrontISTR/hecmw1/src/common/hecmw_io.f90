...
!C====================================================================
!C Get HEC-MW dist mesh from file with Jcup
!C====================================================================

    subroutine hecmw_get_mesh_jcup(name_ID, mesh, my_comm) 
        integer(kind=kint) :: ierr  
        character(len=HECMW_NAME_LEN) :: name_ID
        type(hecmwST_local_mesh) :: mesh
        integer :: my_comm
        ...
        call hecmw_get_mesh_init_if_jcup(name_ID,ierr, my_comm) 
        if(ierr /=0) call hecmw_abort(hecmw_comm_get_comm())
    ...
    end subroutine hecmw_get_mesh_jcup
