...
int OAT_InstallMyMatMul(double C[N][N],double A[N][N],double B[N][N],int n,int iusw1)
{
	switch(iusw1){
	case 1:
		OAT_InstallMyMatMul_1(C, A, B, n);
		break;
	case 2:
		OAT_InstallMyMatMul_2(C, A, B, n);
		break;
	case 3:
		OAT_InstallMyMatMul_3(C, A, B, n);
		break;
	case 4:
		OAT_InstallMyMatMul_4(C, A, B, n);
		break;
	case 5:
		OAT_InstallMyMatMul_5(C, A, B, n);
		break;
	case 6:
		OAT_InstallMyMatMul_6(C, A, B, n);
		break;
	case 7:
		OAT_InstallMyMatMul_7(C, A, B, n);
		break;
	case 8:
		OAT_InstallMyMatMul_8(C, A, B, n);
		break;
	case 9:
		OAT_InstallMyMatMul_9(C, A, B, n);
		break;
	case 10:
		OAT_InstallMyMatMul_10(C, A, B, n);
		break;
	case 11:
		OAT_InstallMyMatMul_11(C, A, B, n);
		break;
	case 12:
		OAT_InstallMyMatMul_12(C, A, B, n);
		break;
	case 13:
		OAT_InstallMyMatMul_13(C, A, B, n);
		break;
	case 14:
		OAT_InstallMyMatMul_14(C, A, B, n);
		break;
	case 15:
		OAT_InstallMyMatMul_15(C, A, B, n);
		break;
	case 16:
		OAT_InstallMyMatMul_16(C, A, B, n);
		break;
	}
	return 0;
}
