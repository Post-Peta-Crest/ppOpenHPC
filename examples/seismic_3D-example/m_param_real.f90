...
!
  ...
  !-- << Binary Size >>
  integer,  parameter :: IWORD   = 1                       ! Unit Record Length for FX10
  !integer,  parameter :: IWORD   = 4                      ! Unit Record Length for Intel
  ...
  !!-- << Put data for MATH/MP >>
  real(PN) :: UVX(1:NXP,1:NYP,1:NZP)
  real(PN) :: UVY(1:NXP,1:NYP,1:NZP)
  real(PN) :: UVZ(1:NXP,1:NYP,1:NZP)
  ...
  integer :: IA(NXP0:NXP1), JA(NYP0:NYP1), KA(NZP0:NZP1)
  integer :: I1, J1, K1
  ...
  integer :: MST  = 100
  integer :: geom_num
  character(len=20),dimension(30) :: geometrylist
  real(PN) :: ZDEP(23,0:201,0:201), RO1(100), VP1(100), VS1(100) !, QQ1(100)
  integer :: kza(24,0:201,0:201)

  !! Station
  integer :: NST  = 100                       ! Stations

  !! For MATH/MP
  integer :: SX0,EX1,SY0,EY1,SZ0,EZ1
