...
c     === OAT_ATexec
c     ============================================================
      subroutine OAT_ATexec(OAT_TYPE, OAT_Routines,il,ig,ILOC,n,W,q)
      integer   OAT_TYPE
      character*9 OAT_Routines
      integer il
      integer ig
      ...
      if (OAT_TYPE .eq. 1) then
        ...
        if (cp .ne. 0) then
          ...
          if (cp .ge. len(OAT_Routines)) then
            call OAT_ATexecInstallMGSKernel(OAT_Routines,il,ig,ILOC,n,W,
     &q)
          endif
        endif
      endif
...
c     ==============================================================
      subroutine OAT_ATexecInstallMGSKernel(OAT_Routines,il,ig,ILOC,n,W,
     &q)
      character*9 OAT_Routines
      integer il
      integer ig
...
!          do iloop_iter=1, OAT_MAXSAMPITER
            ...
            call OAT_InstallMGSKernel(il, ig, ILOC, iloop_n, W, q, iusw1
     &)
