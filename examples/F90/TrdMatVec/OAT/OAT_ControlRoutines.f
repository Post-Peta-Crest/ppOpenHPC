...
c     === OAT_ATexec
c     ============================================================
      subroutine OAT_ATexec(OAT_TYPE, OAT_Routines,local_length_y,local_
     &length_x,A,init_x,init_y,u_y,y_k,al,nx,ny)
      integer   OAT_TYPE
      character*9 OAT_Routines
...
c     ==== Install Optimization
     ...
     &local_length_x,A,init_x,init_y,u_y,y_k,al,nx,ny)
          endif
        endif
      endif
...
!          do iloop_iter=1, OAT_MAXSAMPITER
            ...
            call OAT_InstallMGSKernel(local_length_y, local_length_x, A,
     & init_x, init_y, u_y, y_k, al, nx, ny, iusw1)
