...
c     === OAT_SetParm
c     ============================================================
      subroutine OAT_SetParm(OAT_TYPE, OAT_Routine, n_bpset, isw,N,y,ind
     &_r,A,x,ind_c)
      integer OAT_TYPE
...
c     ==== Run-time Optimization
      if (OAT_TYPE .eq. 3) then
        if (OAT_DYNAMICTUNE) then
          call OAT_ATexecDynamicDU_MatVec(OAT_Routine,isw,N,y,ind_r,A,x,
     &ind_c)
        else
          isw = 1
        endif
...
c     === OAT_ATexec
c     ============================================================
      subroutine OAT_ATexec(OAT_TYPE, OAT_Routines,N,y,ind_r,A,x,ind_c)
      integer   OAT_TYPE
      character*9 OAT_Routines
      integer N
      real*8 y(N)
...
c     ==============================================================
      subroutine OAT_ATexecDynamicDU_MatVec(OAT_Routines,iBestSw1,N,y,in
     &d_r,A,x,ind_c)
      character*9 OAT_Routines
      integer iBestSw1
      integer N
...
!          do iloop_iter=1, OAT_MAXSAMPITER
            ...
            call OAT_DynamicDU_MatVec(iloop_n, y, ind_r, A, x, ind_c, iu
     &sw1)
