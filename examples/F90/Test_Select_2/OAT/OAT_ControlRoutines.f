      ...
      if (OAT_TYPE .eq. 2) then
        ...
        if (cp .ne. 0) then
          ...
          if (cp .ge. len(OAT_Routines)) then
            call OAT_ATexecStaticSelectMatMul2(OAT_Routines,A,B,C,N)
          endif
        endif
      endif
...
c     ==============================================================
      subroutine OAT_ATexecStaticSelectMatMul2(OAT_Routines,A,B,C,N)
      character*13 OAT_Routines
      real*8 A(N,N)
      real*8 B(N,N)
      real*8 C(N,N)
...
!          do iloop_iter=1, OAT_MAXSAMPITER
            ...
            call OAT_StaticSelectMatMul2(A, B, C, iloop_n, iusw1)
