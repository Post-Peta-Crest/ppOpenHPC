...
c     === for chacking debug mode
      in = 350
      OAT_DEBUG = 1
      call OAT_ATexec(OAT_DYNAMIC,OAT_DynamicRoutines,N,ind_r,y,A,x,ind_
     &c)
...
c     =====================================================
      ...
      call OAT_SetParm(3,"DU_MatVec",N,iusw1_DU_MatVec,N,ind_r,y,A,x,ind
     &_c)

       do iter=1, 100

      call OAT_DynamicDU_MatVec(N,ind_r,y,A,x,ind_c,iusw1_DU_MatVec);
