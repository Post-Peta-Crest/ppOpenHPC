...
function kinetic_energy(parameters,particles)

    use ppohDEM_util
    implicit real*8 (a-h,o-z)
    type(ppohDEM_parameters) :: parameters
    type(ppohDEM_particles) :: particles
    real(kind=kreal) :: kinetic_energy

    kinetic_energy=0.
    do i=1,particles%n
        kinetic_energy=kinetic_energy+0.5*parameters%Mass*dot_rvec3(particles%vel(i),particles%vel(i))
    enddo
