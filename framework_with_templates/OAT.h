...
!     === common variables
	 ...
	 &         OAT_MAXSAMPITER,                                         &
	  ...
	  integer  oat_myid
	  integer  oat_nprocs
          common  /OAT_pval/oat_myid,oat_nprocs
...
!        === AT region variables 
         ...
         integer iusw1_ppohBEMmatvec_direct
          ...
          common /OAT_ATswitches/iusw1_ppohBEMresidual_direct,              &
         &                       iusw1_ppohBEMmatvec_direct

         integer iusw1_ppohBEMresidual_direct_flag
         integer iusw1_ppohBEMmatvec_direct_flag

       
          common /OAT_ATswitchFlags/iusw1_ppohBEMresidual_direct_flag,      &
         &                       iusw1_ppohBEMmatvec_direct_flag
