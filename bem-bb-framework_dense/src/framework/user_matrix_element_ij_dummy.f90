...
!=====================================================================*
!****************************************************************************
  real(8) function ppohBEM_matrix_element_ij(i, j, nond, nofc, nond_on_fc, &
                                             np,int_para_fc, nint_para_fc, &
                                             dble_para_fc, ndble_para_fc, &
                                             face2node)
!  use user_func
  ...
  if (i.eq.j) then
    ppohBEM_matrix_element_ij = 1.1
  elseif (i.eq.j+2) then
    ppohBEM_matrix_element_ij=-0.001
  else
    ppohBEM_matrix_element_ij=0.0
  endif
