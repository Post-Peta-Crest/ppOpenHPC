...
subroutine ppohDEM_v_distancecalculate_MPI2 (voxel)
...
!----------------------------------------------------------------
    ...
    allocate(timings_real3(0:10))

    call cpu_time(timings_real3(0)) 
...
!      write log-timings1
!----------------------------------------------------------------
    open (1001, file='log-timings3', status='unknown')

    do i=1, 4
       write(1001,"(1I3,F16.6)") i, timings_real3(i) - timings_real3(i-1)
    end do

    write (1001,"(1A,F16.6)") 'Total ', timings_real3(4) - timings_real3(0) 
