...
!
!=Description
! Finite difference engines for parallel 3D FDM
!
!=Declarations
...
!!OAT$ call OAT_BPset("NZ")
      ...
      call OAT_SetParm(1,ctmp,NZ,iusw1_ppohFDM_pdiffx3_p4)
...
!!OAT$ debug (pp)
        if (OAT_DEBUG .ge. 2)then
          ...
          print *, 'Install Routine: ppohFDM_pdiffx3_p4=',iusw1_ppohFDM_pdiffx3_p4
        endif
!
!    R40 = C40/DX
!    R41 = C41/DX
...
!!OAT$ call OAT_BPset("NZ")
      ...
      call OAT_SetParm(1,ctmp,NZ,iusw1_ppohFDM_pdiffx3_m4)
...
!!OAT$ debug (pp)
        if (OAT_DEBUG .ge. 2)then
          print *, 'oat_myid: ',oat_myid
          print *, 'Install Routine: ppohFDM_pdiffx3_m4=',iusw1_ppohFDM_pdiffx3_m4
        endif
!
!    R40 = C40/DX
!    R41 = C41/DX
...
!!OAT$ call OAT_BPset("NZ")
      ...
      call OAT_SetParm(1,ctmp,NZ,iusw1_ppohFDM_pdiffy3_p4)
...
!!OAT$ debug (pp)
        if (OAT_DEBUG .ge. 2)then
          print *, 'oat_myid: ',oat_myid
          print *, 'Install Routine: ppohFDM_pdiffy3_p4=',iusw1_ppohFDM_pdiffy3_p4
        endif
!
!    R40 = C40/DY
!    R41 = C41/DY
...
!!OAT$ call OAT_BPset("NZ")
      ...
      call OAT_SetParm(1,ctmp,NZ,iusw1_ppohFDM_pdiffy3_m4)
...
!!OAT$ debug (pp)
        if (OAT_DEBUG .ge. 2)then
          print *, 'oat_myid: ',oat_myid
          print *, 'Install Routine: ppohFDM_pdiffy3_m4=',iusw1_ppohFDM_pdiffy3_m4
        endif
!
!    R40 = C40/DY
!    R41 = C41/DY
...
!!OAT$ call OAT_BPset("NZ")
      ...
      call OAT_SetParm(1,ctmp,NZ,iusw1_ppohFDM_pdiffz3_p4)
...
!!OAT$ debug (pp)
        if (OAT_DEBUG .ge. 2)then
          print *, 'oat_myid: ',oat_myid
          print *, 'Install Routine: ppohFDM_pdiffz3_p4=',iusw1_ppohFDM_pdiffz3_p4
        endif
!
!    R40 = C40/DZ
!    R41 = C41/DZ
...
!!OAT$ call OAT_BPset("NZ")
      ...
      call OAT_SetParm(1,ctmp,NZ,iusw1_ppohFDM_pdiffz3_m4)
...
!!OAT$ debug (pp)
        if (OAT_DEBUG .ge. 2)then
          print *, 'oat_myid: ',oat_myid
          print *, 'Install Routine: ppohFDM_pdiffz3_m4=',iusw1_ppohFDM_pdiffz3_m4
        endif
!
!    R40 = C40/DZ
!    R41 = C41/DZ
