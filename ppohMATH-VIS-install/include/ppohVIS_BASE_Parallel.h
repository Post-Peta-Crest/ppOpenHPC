 ...
 *=====================================================================*/
#ifndef __H_PPOHVIS_BASE_PARALLEL
#define __H_PPOHVIS_BASE_PARALLEL
...
extern int
ppohVIS_BASE_Comm_size(ppohVIS_BASE_Comm comm, int *iProcCount);

extern int
ppohVIS_BASE_Comm_rank(ppohVIS_BASE_Comm comm, int *iMyRank);
...
#endif /* __H_PPOHVIS_BASE_PARALLEL */
