...
*****************************************************************
  How to use ppOpen-APPL/FDM with Auto-Tuning version 1.0.0
*****************************************************************
2015.10.5

* How to install source codes to original distribution.

  1. Please put the files of "3.hybrid" in this distribution 
   to directory "ppohFDM_0.2.0/src/seismic_3D/3.hybrid" 
   in original distribution, such as:

>scp -r ./3.hybrid_AT <Root directory of ppOhFDM>/ppohFDM_0.2.0/src/seismic_3D/3.hybrid

  2. Modify "Makefile.option" file to fit your environment.

  3. Type "make" as same as original distribution of ppOpen-APPL/FDM.
