...
subroutine ppohAMRFDM_refine_init(st_param,st_meshset,st_comm_info)
  ...
  integer(kind=ppohAMRFDM_kint)::iLv,ID,index
  if(st_param%LvMax<1) return
  do iLv=st_param%LvMax-1,0,-1
     call ppohAMRFDM_average(iLv,st_param%nfg,st_param%nfg+st_param%nlv,st_param,st_meshset)
  enddo
  do index=0,st_param%LvMax
     do iLv=0,st_param%LvMax-1
        call ppohAMRFDM_setflag(iLv,st_param,st_meshset,st_comm_info)     
        call ppohAMRFDM_addRoct_init(iLv,st_param,st_meshset,st_comm_info)
        call ppohAMRFDM_addGoct_init(iLv,st_param,st_meshset,st_comm_info)
  ...
  return
end subroutine ppohAMRFDM_refine_init
