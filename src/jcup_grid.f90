...
subroutine set_grid_mapping_1d(send_comp_id, recv_comp_id, mapping_tag, &
  ...
  !call palm_TimeStart("SetMapping1")
  ...
  !call palm_TimeEnd("SetMapping1")
  !call palm_TimeStart("SetMapping2")
  ...
  !call palm_TimeEnd("SetMapping2")
  !call palm_TimeStart("SetMapping3")
  ...
  !call palm_TimeEnd("SetMapping3")

  !call palm_TimeStart("SetMapping4")
...
subroutine set_local_grid_mapping_1d(recv_comp_id, send_comp_id, mapping_tag, &
  ...
  !call palm_TimeStart("SetLocalMapping1")
  ...
  !call palm_TimeEnd("SetLocalMapping1")
  !call palm_TimeStart("SetLocalMapping2")

  call set_my_local_grid_index(recv_grid, peg%global_index_of_my_recv_point)

  !call palm_TimeEnd("SetLocalMapping2")

  !call palm_TimeStart("SetLocalMapping3")
  ...
  !call palm_TimeEnd("SetLocalMapping3")

  !call palm_TimeStart("SetLocalMapping4")
  ...
  !call palm_TimeEnd("SetLocalMapping4")
  !call palm_TimeStart("SetLocalMapping5")
  ...
  !call palm_TimeEnd("SetLocalMapping5")
  !call palm_TimeStart("SetLocalMapping6")
  ...
  !call palm_TimeEnd("SetLocalMapping6")
  !call palm_TimeStart("SetLocalMapping7")
  ...
  !call palm_TimeEnd("SetLocalMapping7")
  !call palm_TimeStart("SetLocalMapping8")
  ...
  !call palm_TimeEnd("SetLocalMapping8")
