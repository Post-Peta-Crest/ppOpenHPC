...
subroutine ppohAMRFDM_init(st_comm_info)
  ...
  call mpi_comm_size(st_comm_info%comm,st_comm_info%nprocs,ierr)
  call mpi_comm_rank(st_comm_info%comm,st_comm_info%rank,ierr)
  return
end subroutine ppohAMRFDM_init
