...
!
  ...
  !-<< Execute Title >>
  character(99), parameter :: TITLE="SEISM3D_small"
  ...
  !-<< Parallel >> 
  integer, parameter :: IP     = 1        ! X-Division, >= 2
  integer, parameter :: JP     = 1        ! Y-Division, >= 2
  integer, parameter :: KP     = 1        ! Z-Division, >= 2
  ...
  !-- << Binary Size >>
  integer,  parameter :: IWORD   = 1                       ! Unit Record Length
