...
!
! Subroutines for FDM simulation of seismic wave propagation, 
! such as for setting a seismic source time function.
!
  use ppohFDM_stdio
  implicit none
  public
contains
  ...
  !
  ! Clears a 2D array by setting a special value
  !
  ...
  !
  ! Clears a 3D array by setting a special value
  !
    integer,  intent(in)  :: nx0, nx1
